      ...
      <div className='flex flex-col w-full gap-8 items-center '>
        <div className='flex flex-col w-full items-center select-none'>
          <div className='relative w-5/6 group'>
            <input
              className='w-full rounded-lg px-2 py-3 border-4 border-gray-800/20 bg-transparent text-white/70 outline-none tracking-wide'
        ...
        {pokemon ? (
          <Card
            ...
            stats='15, 20'
            desc='Estoy muy contento por vos sofii! te deseo lo mejor. avisame y hacemos el challenge si queres :D'
          />
        ) : (
          <Card />
        )}
